...
import ConfirmationDialog from './ConfirmationDialog'; // import the new confirmation dialog component

const ProductList = ({ refresh, searchQuery }) => {
    const [products, setProducts] = useState([]);
    const [currentPage, setCurrentPage] = useState(1);
    const [productsPerPage] = useState(10);  // here is the product number for a single page or list
